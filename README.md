# DiscoTech
The MIT Codesign Studio team organized, hosted, participated in, and supported several countersurveillance DiscoTechs (short for “Discovering Technology” events) and hackathons during the spring of 2014. At the Boston DiscoTech I presented the SURVANT-Cryp project and later participated in a variety of countersurveillance workshops and hacking experiments. At this event I was introduced to vojo.co, a platform that allows people to post stories from inexpensive mobile phones via voice calls, SMS, and MMS. Professor Sasha Costanza-Chock led a group of us attendees around the MIT campus capturing images of surveillance cameras, which were then posted here: http://vojo.co/en/discotech.
